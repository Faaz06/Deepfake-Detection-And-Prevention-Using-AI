...
st.markdown("<h1 style='text-align: center; color: grey;'>DEEP FAKE DETECTION AND PREVENTION</h1>", unsafe_allow_html=True)
...
---
**Contact Us:**
For more information and queries, please contact us at [adnan123@gmail.com](kfaaz199@gmail.com).
